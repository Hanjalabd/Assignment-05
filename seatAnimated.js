...
for (const seat of busSeat) {
  seat.addEventListener("click", function (event) {
    ...
    if (userPressed) {
      ...
      const totalPayment = totalBdt + 550;
      ...
      if (selectedSeat === 4) {
        ...
        setTextElementValueById("total-price", 2200);
        setTextElementValueById("grand-total", 2200);
...
function confirm(){
  hideElementById('home-screen');
  hideElementById('hh-paribahan')
  hideElementById('container-screen')
  hideElementById('total-seat')
  hideElementById('footer')
  showElementById('succesful')  
}